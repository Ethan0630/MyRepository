export const fetchCategories = async () => {
    try {
        const response = await fetch("http://13.115.110.126:9060/cat/getCategories");
...
export const uploadCategory = async (categoryName) => {
    try {
        ...
        const response = await fetch("http://13.115.110.126:9060/admin/cat/upload", {
            method: "POST",
            headers: {
                // ✅ 關鍵：要帶上 token！
...
export const deleteCategory = async (selectedCategory) => {
    ...
    try {
        ...
        const response = await fetch(`http://13.115.110.126:9060/admin/cat/delete/${selectedCategory}`, {
            method: "DELETE",
            headers: {
                // ✅ 關鍵：要帶上 token！
                "Authorization": "Bearer " + token
